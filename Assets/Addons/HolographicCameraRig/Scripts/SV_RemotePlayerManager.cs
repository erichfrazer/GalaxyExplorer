...
namespace SpectatorView
{
    ...
    public class SV_RemotePlayerManager : SpectatorView.SV_Singleton<SV_RemotePlayerManager>
    {
        ...
        protected override void OnDestroy()
        {
            ...
            {
                SharingSessionTracker.Instance.SessionJoined -= SessionUsersTracker_UserJoined;
                SharingSessionTracker.Instance.SessionLeft -= SessionUsersTracker_UserLeft;
            }
        ...
        void OnEditorUser(HoloToolkit.Sharing.NetworkInMessage msg)
        {
            ...
            {
                User user = SharingSessionTracker.Instance.GetUserById((int)editorUserID);
                if (user != null)
                {
        ...
        void Update()
        {
            if (!registeredSharingStageCallbacks && SharingStage.Instance != null &&
                HolographicCameraManager.Instance != null && SharingSessionTracker.Instance != null)
            {
        ...
        /// </summary>
        private void SessionUsersTracker_UserLeft(object sender, SharingSessionTracker.SessionLeftEventArgs e)
        {
            if (remoteHeads.ContainsKey(e.exitingUserId))
            {
#if UNITY_EDITOR
                if (HolographicCameraManager.Instance != null &&
                    remoteHeads[e.exitingUserId].IP != null && 
                    remoteHeads[e.exitingUserId].IP == HolographicCameraManager.Instance.HolographicCameraIP.Trim() &&
                ...
                RemoveRemoteHead(remoteHeads[e.exitingUserId].HeadObject);
                remoteHeads.Remove(e.exitingUserId);
            }
        }
        ...
        /// </summary>
        private void SessionUsersTracker_UserJoined(object sender, SharingSessionTracker.SessionJoinedEventArgs e)
        {
        ...
        public RemoteHeadInfo GetRemoteHeadInfo(long userID)
        {
            ...
            if (headInfo.IP != null && HolographicCameraManager.Instance != null && 
                ...
                SharingSessionTracker.Instance != null)
            {
                    ...
                    HolographicCameraManager.Instance.HolographicCameraIP.Trim() != String.Empty)
                {
                    ...
                    User user = SharingSessionTracker.Instance.GetUserById((int)userID);
                    if (user != null)
                    {
